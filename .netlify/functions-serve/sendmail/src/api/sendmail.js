...
var require_package = __commonJS({
  "node_modules/nodemailer/package.json"(exports, module2) {
    module2.exports = {
      ...
      _spec: "nodemailer",
      _where: "C:\\Users\\henri\\Documents\\Develop\\Websites\\jr-guitar",
      author: {
        name: "Andris Reinman"
      },
      bugs: {
...
var MailerService = class {
  ...
  async sendMail(fromName, fromAddress, subject, message) {
    if (process.env.MAIL_LOGIN) {
      ...
      this.smtpConfig = {
        host: process.env.MAIL_HOST != null ? process.env.MAIL_HOST : "mail.shaw.ca",
        port: process.env.MAIL_PORT != null ? parseInt(process.env.MAIL_PORT) : 25,
        secure: false
      };
    }
